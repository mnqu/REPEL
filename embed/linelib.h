...
protected:
    ...
    void train_uv_od3(int u, int v, real lr, int neg_samples, real *_error_vec, unsigned long long &rand_index);
public:
    line_trainer_line();
    ~line_trainer_line();
    ...
    void train_sample_od3(real lr, int neg_samples, real *_error_vec, double (*func_rand_num)(), unsigned long long &rand_index);
